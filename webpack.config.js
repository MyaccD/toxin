...
module.exports = (env, options) => {
    ...
    const publicDir = production ? 'https://myaccd.github.io/toxin/' : '/';
    ...
    return {
        ...
        plugins: [
            ...
            new FaviconsWebpackPlugin({
                ...
                favicons: {
                    appName: 'Toxin',
                    appDescription: 'Cайт для поиска номеров в отеле.',
                    developerName: 'myaccd',
                    icons: {
                        android: false,
                        appleIcon: false,
                        appleStartup: false,
            ...
            new HtmlWebpackPlugin({
                template: `${PAGES_DIR}/colors_type/colors_type.pug`,
